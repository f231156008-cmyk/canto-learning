(function () {
  const pages = [
    ...
    ["quiz.html", "练习"], ["characters.html", "字形"],
    ["cha-chaan-teng.html", "在地"], ["wordlist.html", "词库"], ["profile.html", "我的"]
  ];
  ...
  function setupHome() {
    ...
    document.getElementById("todayDate").textContent = new Intl.DateTimeFormat("zh-Hant-HK", { year: "numeric", month: "long", day: "numeric", weekday: "long" }).format(new Date());
    ...
    if (category || level) {
      ...
      document.getElementById("continueMeta").textContent = "继续上次选择的词汇路线";
    }
